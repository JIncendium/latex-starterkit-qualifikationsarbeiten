...
Nachdem im Abschnitt 2 die theoretische Basis zu Softwarearchitektur Modellierung und Softwarearchitektur erläutert wurde, stellt sich nun die Frage, wie die Forschungsfragen im Rahmen dieser Masterarbeit am besten beantwortet werden können. Hierfür wurde der qualitative Forschungsansatz gewählt. Da der Analysegegenstand Softwarearchitekten und ihre Nutzung von Modellierungssprachen sind ist die geisteswissenschaftliche Methodik des Verstehens dem Analysegegenstand gegenüber angemessen und realitätsgerechter.\footnote{Vgl.  Siegfried Lamnek, Qualitative Sozialforschung, Beltz Verlagsgruppe, 2010, S. 27}
