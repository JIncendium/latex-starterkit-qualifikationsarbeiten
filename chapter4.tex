...
In dieser Kategorie finden sich Aussagen der Architekten zur Einschätzung der Zukunft der Architektur, aber auch grundlegende Ansichten zum Architekturverständnis bis hin zu Definitionen der einzelnen Softwarearchitekten zum Begriff Softwarearchitektur. Die Zukunft der Softwarearchitektur wird vielen Softwarearchitekten als komplexer und feingranularer eingeschätzt.\footnote{siehe Anhang A7 Sonstiges} 
...
Mehrfach wurde auch die Toolunterstützung als wesentliche Anforderung an eine Modellierungssprache genannt.\footnote{Vgl.Anhang B4 Anwenderbezogene Anforderungen}
...
Ein Softwarearchitekt formuliert es gegenläufig, hier wird Ausdruckstärke als weniger wichtig angegeben. \footnote{Vgl. Anhang B5 Anwendungsbezogene Anforderungen}
...
Die Befragten haben viele unterschiedliche Aspekte in den Interviews genannt, die sich unter diese Kategorie zusammenfassen lassen. Folgende Punkte spiegeln die Antworten der Architekten wider. \footnote{Vgl. Anhang C3 Allgemeine Verbesserungsvorschläge}
