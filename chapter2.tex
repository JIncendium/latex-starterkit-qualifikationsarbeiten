...
Im Bereich der Softwarearchitektur haben sich eine Vielzahl von Modellierungssprachen etabliert. Zu diesen zählen unter anderem die Unified Modeling Language (UML), die System Modeling Language (SysML), Business Process Model an Notation (BPMN) und Architecture Modeling Language (Archimate). Eine nähere Betrachtung der Eigenschaften sowie eine geeignete Auswahl von Modellierungssprachen wird in der eigentlichen Qualifikationsarbeit vorgenommen. 
